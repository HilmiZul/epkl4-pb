...
migrate((app) => {
  ...
  const collection = new Collection({
    ...
    "id": "pbc_2735705349",
    "indexes": [
      "CREATE UNIQUE INDEX `_1d4fljtg4b3ycm6_username_idxjgm` ON `teacher_users_duplicate` (`username` COLLATE NOCASE)",
      "CREATE INDEX `_1d4fljtg4b3ycm6_email_idxyu2` ON `teacher_users_duplicate` (`email`) WHERE `email` != ''",
      "CREATE UNIQUE INDEX `_1d4fljtg4b3ycm6_tokenKey_idx7i6` ON `teacher_users_duplicate` (`tokenKey`)",
      "CREATE UNIQUE INDEX `idx_email_1d4fljtg4b3ycm6tbm` ON `teacher_users_duplicate` (`email`) WHERE `email` != ''"
    ],
